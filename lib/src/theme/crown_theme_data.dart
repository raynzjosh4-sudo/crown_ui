...
class CrownThemeData {
  ...
  factory CrownThemeData.light() {
    return CrownThemeData(
      colors: CrownColors.light(),
      typography: CrownTypography.light(),
      spacing: CrownSpacing.default_(),
      borders: CrownBorders.default_(),
    );
  }

  factory CrownThemeData.dark() {
    return CrownThemeData(
      colors: CrownColors.dark(),
      typography: CrownTypography.light(),
      spacing: CrownSpacing.default_(),
      borders: CrownBorders.default_(),
    );
  ...
  CrownThemeData copyWith({
    CrownColors? colors,
    CrownTypography? typography,
    CrownSpacing? spacing,
    CrownBorders? borders,
  }) {
    return CrownThemeData(
